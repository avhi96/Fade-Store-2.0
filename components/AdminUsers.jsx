...
import { Users, ShoppingBag, Search, ArrowLeft } from 'lucide-react'
  ...
  return (
    <section className='max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12'>
      ...
      <div className='mb-8'>
        <Link
          href='/admin'
          className='inline-flex items-center gap-2 text-gray-400 hover:text-white transition p-3 rounded-lg hover:bg-white/5'
        >
          <ArrowLeft size={20} />
      ...
      <div className="text-center mb-12">
        ...
        <p className='text-gray-400'>
          Manage all users, bans, and activity ({filteredUsers.length})
        </p>
      ...
      <div className="flex flex-wrap gap-4 justify-center mb-8 max-w-4xl mx-auto">
        ...
        <div className="flex bg-white/5 border border-white/10 rounded-xl p-1">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition cursor-pointer ${filter === 'all'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition cursor-pointer ${filter === 'active'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition cursor-pointer ${filter === 'points'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition cursor-pointer ${filter === 'buyers'
              ...
              {filteredUsers.map((user) => (
                ...
                >
                  ...
                  <td className="p-4">
                    ...
                    <Link
                      href={`/admin/users/${user.id}/purchases`}
                  ...
                  <td className="p-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      {ADMIN_IDS.includes(getDiscordId(user)) ? (
      ...
      <div className="mt-12 text-xs text-gray-500 text-center">
        ...
        Users data loaded from API route.
